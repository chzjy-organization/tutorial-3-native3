...
public:
	...
	static void ShowImg(int win_num, IplImage *src) {
		...
		char windowName[22];
		sprintf(windowName, "外部img_%d\0", win_num);
...
//	int ny[2]={0};
	...
	if(r2.height * r2.width > CONTOUR_MAX_AERA) // 面积小的方形抛弃掉
              {
...
int itest=0;
IplImage *Zero=NULL;
JNIEXPORT jint JNICALL Java_org_opencv_samples_tutorial3_Sample3View_FindFeatures(
